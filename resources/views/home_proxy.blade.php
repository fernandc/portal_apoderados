            ...
            <div class="tab-content" id="myTabContent">
                @if($dataProxy == NULL)
                    <div class="alert alert-danger" role="alert">
                        Debe completar formulario <a href="/apoderados/home?active=info">Actualizar mi información</a> y <a href="/apoderados/home?active=circle">Mi círculo Familiar</a> para proceder a matrículas de estudiantes <i class="fas fa-exclamation-triangle"></i> 
                    </div>
                @endif
